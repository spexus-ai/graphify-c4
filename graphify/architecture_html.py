...
<div id="sidebar">
  ...
  <div id="legend-wrap"><h3>Relationship evidence</h3><div class="edge-key"><i></i>Declared contract</div><div class="edge-key"><i class="observed"></i>Observed code evidence</div></div>
  <div id="stats"></div>
</div>
<script>
...
const level = document.querySelector('#level'), focus = document.querySelector('#focus'), info = document.querySelector('#info-content'), stats = document.querySelector('#stats'), search = document.querySelector('#search'), results = document.querySelector('#search-results');
...
let currentNodes = [], currentRelations = [];
...
level.onchange=updateGraph;focus.onchange=updateGraph;document.querySelector('#reset').onclick=()=>{focus.value='';updateGraph();};renderFocus();updateGraph();
</script></body></html>"""
